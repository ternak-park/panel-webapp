...
Route::middleware(['auth', 'user-access:admin,petugas'])->group(function () {
    // Admin & Petugas Home Routes
    Route::get('/admin/home', [HomeController::class, 'adminHome'])->name('admin.home')->middleware('user-access:admin');
    Route::get('/petugas/home', [HomeController::class, 'petugasHome'])->name('petugas.home')->middleware('user-access:petugas');
