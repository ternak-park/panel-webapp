...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        $('thead input[type="checkbox"]').on("change", function () {
            ...
            $('#tableHewan tbody input[type="checkbox"]').prop("checked", isChecked);
        ...
        $(document).on("change", '#tableHewan tbody input[type="checkbox"]', function () {
            updateDeleteButtonState();
        });
    
        // Helper function to update delete button state
        function updateDeleteButtonState() {
            const checkedCount = $('#tableHewan tbody input[type="checkbox"]:checked').length;
        ...
        $(document).ready(function() {
            ...
            $("#deleteSelected").on("click", function() {
                ...
                $('#tableHewan tbody input[type="checkbox"]:checked').each(function() {
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire(
                                    "Dihapus!",
                                    response.success || "Data terpilih telah dihapus.",
                                    "success"
                                ).then(() => {
                                    // Refresh the table
                                    $('#tableHewan').DataTable().ajax.reload();
