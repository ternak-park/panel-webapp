    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    <form class="card" method="POST" action="{{ route('status.update', $status->id) }}" id="statusForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kode_status" name="kode_status" value="{{ old('status', $status->kode_status) }}" readonly disabled />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Status</label>
                                        <input type="text" class="form-control" name="nama_status" value="{{ old('status', $status->nama_status) }}"  />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-12">
                                        ...
                                        <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3" maxlength="100">{{ old('status', $status->deskripsi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
